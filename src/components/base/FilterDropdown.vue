<template>
    <div class="filter-dropdown" @click="toggleDropdown">
            <div class="filter-dropdown-text">{{ selectedText }}</div>
            <div 
                class="filter-dropdown-data"
                :class="{ 'filter-dropdown-hidden': isClose }"
            ...
            >
                <div 
                    ...
                    :value="item.Value"
                    :class="{ 'filter-dropdown-selected': activeItem(index) }"
                >
                    <div 
                      class="filter-dropdown-item-icon"
                      :class="{ 'icon-selected': !activeItem(index) }"
                    >
                    </div>

                    <div class="filter-dropdown-item-text">
                        {{ item.Text }}
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
    /**--------------------------------------------------------------------
     * Hàm bắt sự kiện click gửi value sang cho bên FormDetail
     ...
     */
    selectItem(index) {
      this.selectedText = this.items[index].Sign;
...
<style scoped>
@import url(../../css/base/filterDropdown.css);
</style>